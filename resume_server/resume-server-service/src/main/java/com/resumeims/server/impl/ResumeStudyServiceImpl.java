...
import com.resumeims.server.dao.ResumeStudyMapper;
...
@Slf4j
@Service
public class ResumeStudyServiceImpl extends SuperServiceImpl<ResumeStudyMapper, ResumeStudy> implements ResumeStudyService {
