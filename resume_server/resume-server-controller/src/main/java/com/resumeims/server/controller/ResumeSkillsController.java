...
import com.resumeims.server.ResumeSkillsService;
import com.resumeims.server.dto.ResumeSkillsPageDTO;
import com.resumeims.server.dto.ResumeSkillsSaveDTO;
import com.resumeims.server.dto.ResumeSkillsUpdateDTO;
 ...
 * @Package: com.resumeims.server.controller
 * @ClassName: ResumeSkillsController
...
@Validated
@RestController
@RequestMapping("/resumeSkillsController")
@Api(value = "ResumeSkillsController", tags = "简历主页信息控制层")
public class ResumeSkillsController extends SuperController<ResumeSkillsService, Long, ResumeSkills, ResumeSkillsPageDTO, ResumeSkillsSaveDTO, ResumeSkillsUpdateDTO> {
    @Autowired
