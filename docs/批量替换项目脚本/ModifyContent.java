...
public class ModifyContent {
    //这个路径不能含有changqing字符!!!!!!! 先将 changqing-commons-plus 修改为tangyh-commons-plus
    //这个路径不能含有changqing字符!!!!!!! 先将 changqing-commons-plus 修改为tangyh-commons-plus
    //这个路径不能含有changqing字符!!!!!!! 先将 changqing-commons-plus 修改为tangyh-commons-plus
//    static String dir = "/Users/tangyh/gitlab/test/tangyh-commons-plus";// 文件所在路径，所有文件的根目录，记得修改为你电脑上的文件所在路径
    static String dir = "E:\\work\\idea-workspace\\huasheng\\Back-end-tanbao";// 文件所在路径，所有文件的根目录，记得修改为你电脑上的文件所在路径
    static String newStr = "tanbao";
    static String oldStr = "changqing";
    ...
    public static void main(String[] args) {
        //这个路径不能含有changqing字符
        File f = new File(dir);
        print(f, 0, "E:\\work\\idea-workspace\\huasheng\\Back-end-tanbao", "E:\\work\\idea-workspace\\huasheng\\tanbao");
    }
