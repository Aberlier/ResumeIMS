/*
 ...
 Source Schema         : changqing_defaults
...
-- ----------------------------
BEGIN;
INSERT INTO `d_datasource_config` VALUES (1298615115649646592, 'alibaba-扩展服务', 'root', 'root', 'jdbc:mysql://127.0.0.1:3306/changqing_aext_new?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true', 'com.mysql.cj.jdbc.Driver', '2020-08-26 21:35:45', 1, '2020-09-03 17:23:57', 2);
INSERT INTO `d_datasource_config` VALUES (1300075361224097792, 'alibaba-基础服务', 'root', 'root', 'jdbc:mysql://127.0.0.1:3306/changqing_aaa_new?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true', 'com.mysql.cj.jdbc.Driver', '2020-08-30 22:18:15', 2, '2020-09-03 17:23:45', 2);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `xxl_job_qrtz_trigger_group` VALUES (1, 'changqing-jobs-server', '单机执行器', 1, 0, NULL);
INSERT INTO `xxl_job_qrtz_trigger_group` VALUES (2, 'changqing-executor-server', '分布式执行器', 2, 0, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `xxl_job_qrtz_trigger_registry` VALUES (28, 'EXECUTOR', 'changqing-jobs-server', '127.0.0.1:8771', '2020-08-10 23:10:59');
COMMIT;
