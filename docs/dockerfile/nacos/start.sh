...
docker stop changqing_nacos
docker rm changqing_nacos
docker run -idt --name changqing_nacos --restart=always \
        ...
        -e MYSQL_SERVICE_HOST=192.168.2.178 -e MYSQL_SERVICE_DB_NAME=changqing_nacos -e MYSQL_SERVICE_PORT=3218 \
